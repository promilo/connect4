...
$this->load->library('securimage');
	...
	echo form_input('email',set_value('email'),"required");
        ...
        echo '<img id="captcha" src="'.site_url('account/securimage').'" alt="CAPTCHA Image" />';
        echo form_input('captcha_code',set_value('captcha_code'),"required");
        echo '<a href="#" onclick="document.getElementById("captcha").src = '.site_url('account/securimage?').' + Math.random(); return false">[ Different Image ]</a>';
