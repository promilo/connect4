...
class Account extends CI_Controller {
    ...
    function createNew() {
        ...
        $this->form_validation->set_rules('captcha_code', 'Captcha', "required|callback_captcha_code_check");
    ...
    public function captcha_code_check($str) {
        ...
        if ($securimage->check($str)) {
            ...
            $this->form_validation->set_message('captcha_code_check', 'The code you enter is not correct');
            return FALSE;
        }
    }
